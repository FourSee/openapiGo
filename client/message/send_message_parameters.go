...
// WithMessageinput adds the messageinput to the send message params
func (o *SendMessageParams) WithMessageinput(messageinput *models.MessageInput) *SendMessageParams {
	o.SetMessageinput(messageinput)
	return o
}

// SetMessageinput adds the messageinput to the send message params
func (o *SendMessageParams) SetMessageinput(messageinput *models.MessageInput) {
